...
export default function SuccessPage() {
  ...
  // Opțional: Putem afișa un mesaj scurt de verificare
  useEffect(() => {
    // Aici ai putea face un fetch către API-ul tău să verifici statusul,
    // dar pentru moment e suficient să îi mulțumim.
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 text-center bg-white p-10 rounded-xl shadow-lg">
        ...
        <p className="mt-6 text-xs text-gray-400">
          ID Tranzacție: <span className="font-mono">{sessionId?.slice(0, 10)}...</span>
        </p>
      </div>
    </div>
  );
